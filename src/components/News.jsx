...
export const News = ({ isNew, title, date, imgNews }) => {
  return (
    <div className='max-w-xs rounded-lg bg-gray-800 shadow-md duration-200 hover:scale-105 hover:shadow-xl my-3 border-b-4 border-blue-500'>
      <img src={imgNews} alt='People' className='w-full object-cover h-32 sm:h-48 md:h-64' />
      <div className='p-4 md:p-6'>
        ...
        <div className='flex justify-end mt-4'>
          <Button className='inline-flex items-center my-3 py-1 px-3 text-sm font-medium text-center text-white bg-transparent rounded-lg focus:ring-4 focus:outline-none transition ease-in-out delay-150 hover:bg-[#ff4655] focus:ring-blue-800 border border-blue-100'>
            Leer
